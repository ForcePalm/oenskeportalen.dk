...
<div class="content-container">
    ...
    <div class="wish-links">
        ...
        <a href="<?= $this->Url->build(['controller' => 'Wishes', 'action' => 'edit', $wish->uuid]) ?>">Rediger<span class="fa-solid fa-pen-to-square fa-lg"></span></a>
        <a href="<?= $this->Url->build(['controller' => 'Wishes', 'action' => 'delete', $wish->uuid]) ?>">Slet<span class="fa-solid fa-trash fa-lg"></span></a>
    </div>   
